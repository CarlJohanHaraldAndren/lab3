...
class Game:
    ...
    def __init__(self, cannonSize, ballSize):
        self.players = [(False, -90, 'blue'), (True, 90, 'red')]
    ...
    """ The number (0 or 1) of the current player. 
    This should be the position of the current player in getPlayers(). """
...
class Player:
    ...
    def __init__(self, Game, fireDir, pos, color):
